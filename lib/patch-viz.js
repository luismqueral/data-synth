...
export class PatchViz {
    ...
    /**
     * Set SVG width and trigger layout recalculation
     * 
     * Call this when viewport changes (window resize, panel toggle, etc.)
     * Note: This only sets the width - you must call render() after to update layout
     * 
     * @param {number} width - New width in pixels
     */
    setWidth(width) {
        // Set both attribute and style to ensure it takes effect
